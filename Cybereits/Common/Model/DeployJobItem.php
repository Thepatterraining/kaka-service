<?php
namespace Cybereits\Common\Model;
...
{
    const createStr ="CREATE TABLE `system_deploy_jobitem` (
    ...
    protected $table = "system_deploy_jobitem";
    ...
    public static function CheckTable()
    {
        ...
        return $sqlHelper->checkTableIsExists("system_deploy_jobitem");
    }
