...
class IsPaypwdTest extends TestCase
{
    /**
    ...
    protected function ispaypwd($token)
    {
        $response = $this->json(
            'POST', '/api/user/paypwdisempty', [
            "accessToken"=>$token,
            ]
        );
        $response->assertStatus(200);
