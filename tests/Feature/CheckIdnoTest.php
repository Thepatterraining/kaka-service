...
class CheckIdno extends TestCase
{
    /**
    ...
    public function testCheckIdno()
    {
        ...
        // dump('判断身份证号是否正确');
        // $name = '周涛';
        // $idno = '421126199803263817';
        // $response = $this->CheckIdno($token,$name,$idno);
        // dump($response);
    ...
    protected function CheckIdno($token, $name, $idno)
    {
        $response = $this->json(
            'POST', '/api/auth/checkidno', [
            "accessToken"=>$token,
            "name"=>$name,
            "idno"=>$idno,
            ]
