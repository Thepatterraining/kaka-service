...
class GetResourcelistTest extends TestCase
{
    /**
    ...
    public function testExample()
    {
        ...
        dump('开始查找');
        $modelId="西城房产收益权001号";
        // $response = $this->buy($token, $modelId);
        // dump($response);
        // $this->assertCount(4,$response);
        // $this->assertEquals(0,$response['code']);
    }
    
    protected function buy($token,$modelId)
    {
        $response = $this->json(
            'POST', 'api/token/resource/getresourcelist', array(
            "accessToken"=>$token,
            "modelid"=>$modelId,
            )
        );
