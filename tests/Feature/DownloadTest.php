...
class DownloadTest extends TestCase
{
    ...
    public function testExample()
    {
        ...
        $this->assertEquals(0, $response['code']);
         ...
         $typeId = 1;
         $file = '123qweA';
         $resourceId="59c4d4d3c3666e00c017ee64";
        //  $response = $this->Download($token,$resourceId,$typeId);
        //  dump($response);
        //  $this->assertCount(4, $response);
        //  $this->assertEquals(0, $response['code']);
    }
    protected function Download($token,$resourceId,$typeId)
    {
        $response = $this->json(
            'POST', '/api/v2/admin/resource/download', [
            "accessToken"=>$token,
