...
class WechatRegTest extends TestCase
{
    /**
    ...
    public function testWechatAppReg()
    {
        ...
        //微信用户注册
        // dump('微信用户注册：');
        // $openid = 'olzNZwS7_QdxJgtUzkr6NWJLB40I';
        // $appid = 'wx6cc547659c946f03';
        // $pwd = "123qwe";
        // $paypwd = '1234qweA';
        // $code = 'KaKamfv5';
        // $data['mobile'] = '13021948064';
        // $data['data'] = $data;
    ...
    protected function appReg2($token, $openid, $appid, $pwd, $paypwd, $data = [], $code)
    {
        $response = $this->json(
            'POST', '/api/wechat/reg', [
            "accessToken"=>$token,
