...
class RechargeFalseTest extends TestCase
{
    /**
    ...
    public function testGetChannels()
    {
        ...
        $channelid = '2';
        $amount = '300';
        // $response = $userRechargeData->ThirdPartyRecharge($amount, $channelid);
        $rechargeNo = 'CR2017081419174005927';
        
        // $response = $userRechargeData->ThirdPartyRechargeFalse($rechargeNo, $channelid);
        // dump($response);
        // $this->assertCount(4,$response);
        // $this->assertEquals(0,$response['code']);
    }
