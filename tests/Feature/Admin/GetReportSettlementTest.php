...
class GetReportSettlementTest extends TestCase
{
    /**
    ...
    public function testGet()
    {
        ...
        $pageIndex = 1;
        $pageSize = 10;
        $response = $this->getReportSettlement($token, $pageIndex, $pageSize);
        dump($response);
        // $this->assertCount(4, $response);
        // $this->assertEquals(0, $response['code']);
    }

    protected function getReportSettlement($token, $pageIndex, $pageSize)
    {
        $response = $this->json(
            'POST', '/api/settlement/getreportsettlementlist', [
            "accessToken"=>$token,
            "pageIndex"=>$pageIndex,
            "pageSize"=>$pageSize,
            ]
