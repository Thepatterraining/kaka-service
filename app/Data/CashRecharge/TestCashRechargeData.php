 ...
 * @date   2017.11.22
 */
class TestCashRechargeData extends IDataFactory implements ICashRecharge
{
     ...
     * @version 0.1
     */
    public function recharge($amount, $bankId = '', $phone = '')
    {
        $lk = new LockData();
        ...
        $rechargeNo = $cashRechageData->addRecharge($phone, $amount, $bankId, $desbankId, $date, RechargeData::APPLY_TYPE, $channelid);
