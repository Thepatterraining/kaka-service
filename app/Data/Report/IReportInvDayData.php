...
use App\Data\Report\ReportInvDayData;

abstract class IReportInvDayData extends IDataFactory
{
    ...
    protected $modelclass = 'App\Model\Report\ReportInvDay';
    ...
    public function makeReport($start, $end, $reportType)
    {
        ...
        $createfilter = $invitationAdapter->getFilers($querycreatefilter);
        ...
        $createResult = $invitationData->userquery("created_at", $querycreatefilter, $pageSize, $pageIndex);
