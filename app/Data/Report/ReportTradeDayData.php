...
class ReportTradeDayData extends IReportTradeDayData implements IDaySchedule
{
    ...
    protected $reportAdapter = "App\Http\Adapter\Report\ReportTradeDayAdapter";
    // protected $noPre = "SCR";
    protected $reportData="App\Data\Report\ReportTradeDayData";
    ...
    protected $tranactionBuyData="App\Data\Trade\TranactionBuyData";
     ...
     * @param $end  结束时间
     */   
    public function getLastReport($end)
    {
        $model=$this->newitem();
        $rep=$model->orderBy('report_end', 'desc')->where('report_end', '<=', $end)->skip(1)->first();
        return $rep;
    }
