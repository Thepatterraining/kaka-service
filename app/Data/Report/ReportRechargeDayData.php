...
class ReportRechargeDayData extends IReportRechargeDayData implements IDaySchedule
{
    ...
    protected $reportAdapter = "App\Http\Adapter\Report\ReportRechargeDayAdapter";
    // protected $noPre = "SCR";
