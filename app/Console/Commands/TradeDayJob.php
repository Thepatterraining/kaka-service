...
use App\Data\Report\IReportTradeDayData;


class TradeDayJob extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'kk:tradeday {start} {end}';
     ...
     * @var string
     */
    protected $description = 'Make History Trade Day Sheet';
    ...
    public function handle()
    {
        ...
        while($tmp_start!=$end)
        {
            ...
            $start_date=date_format($tmp_start, "Y-m-d");
            $end_date=date_format($tmp_end, "Y-m-d");
            $items=$reportTradeDayData->makeReport($start_date, $end_date, "CYC02");
