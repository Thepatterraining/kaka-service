...
class CreateRemittance extends Controller //step 2
{
    ...
    public function run() //step 3
    {
        ...
        $FinanceBankData->addBankCard($bankId, $name, $branchName, null, $bankNo);
        ...
        $desbankId = $bankAccountData->getBankid(BankAccountData::TYPE_PLATFORM);
