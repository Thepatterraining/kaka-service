...
class Reg extends Controller
{
    ...
    protected function run()
    {
        ...
        $imgVerify = $this->request->input('imgVerify');
        ...
        //判断图形验证码是否正确
        if ($datafac->checkLoginCode($imgVerify) === false) {
